		...
		<div class="px-4 sm:px-6 lg:px-8">
			...
			<div class="sm:flex sm:items-center">
				<div class="sm:flex-auto">
					<h1 class="text-xl font-semibold text-gray-900">Testimonios</h1>
					<p class="mt-2 text-sm text-gray-700">Lista de todos tus testimonios</p>
				</div>
			</div>
							...
							<table class="min-w-full divide-y divide-gray-300">
								...
								<tbody class="divide-y divide-gray-200 bg-white">
									...
									@foreach($testimonials as $testimony)
										<tr>
											<td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{ $testimony->name }}</td>
											<td class="px-3 py-4 text-sm text-gray-500 max-w-2xl">{{ $testimony->description }}</td>
