					...
					@if(Route::currentRouteName() === 'home' || Route::currentRouteName() === 'products.index')
						<section class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24" id="sobre mi">
							...
							<div class="text-center">
								...
								@if(Route::currentRouteName() === 'home')
									<p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">Hola! Soy Daniel, técnico electrónico con más de 5 años de
										experiencia en el rubro de la electrónica y reparaciones.
									</p>
