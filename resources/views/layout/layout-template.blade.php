...
{{--		<link rel="stylesheet" href="{{ asset('build/assets/app.8ceca43f.css') }}">--}}
	...
	<body>
		...
		<main>
			...
			<div class="fixed inset-0 hidden items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start z-20" id="notification">
						...
						<div class="p-4">
							<div class="flex items-start">
								...
								<div class="ml-3 w-0 flex-1 pt-0.5">
									...
									<p class="mt-1 text-sm text-gray-500">Te responderemos a la brevedad.</p>
								</div>
